...
const validateFormInput = (payload) => {
...
const handleFormSubmit = (props) => (event) => {
    ...
    const isValid = validateFormInput(payload);

    if (!isValid) return props.handleInvalidInput();
                            ...
                            <form id="contactForm" name="sentMessage" noValidate="" onSubmit={handleFormSubmit(props)}>
                                ...
                                <div id="success">
                                    <SuccessDialog
                                        ...
                                        closeSuccessDialog={props.closeSuccessDialog}
                                    />
                                </div>
                                <div className="row">
