...
const handleOnClick = (closeSuccessDialog) => (event) => {
    ...
    if (props.displaySuccessDialog) {
        ...
        return (
            <div className={`alert ${className}`}>
                <button type='button' className='close' aria-hidden='true' onClick={handleOnClick(props.closeSuccessDialog)}>&times;</button>
